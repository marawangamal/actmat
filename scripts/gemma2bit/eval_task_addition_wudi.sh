#!/bin/bash
#SBATCH --job-name=eval_gemma2bit_wudi
...
# Parallel companion to eval_task_addition.sh — runs ONLY the wudi method
# and writes results to the canonical artifacts/results/ location.
set -euo pipefail
