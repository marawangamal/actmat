...
# tasks, with the lighteval fork (same stack as tesh.sh). Experts are the
...
#   de -> global_mmlu_lite:de, mrewardbench_mcf:de, mgsm_custom:de|5
#   es -> global_mmlu_lite:es, mrewardbench_mcf:es, mgsm_custom:es|5
#
# Usage:
#   sbatch scripts/polyglot-all/eval_experts.sh
#   EXPERT=de bash scripts/polyglot-all/eval_experts.sh   # single expert, no array
set -euo pipefail
