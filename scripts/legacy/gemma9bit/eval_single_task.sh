#!/bin/bash
#SBATCH --job-name=eval_gemma9bit_single
...
# Evaluate each MergeBench Gemma-2-9B-IT expert on its corresponding task(s).
...
OLMES_TASKS[MergeBench/gemma-2-9b-it_instruction]="ifeval::tulu"
OLMES_TASKS[MergeBench/gemma-2-9b-it_math]="gsm8k::tulu"
OLMES_TASKS[MergeBench/gemma-2-9b-it_coding]="codex_humanevalplus::tulu mbppplus:0-shot-chat"
...
for MODEL_ID in "${!OLMES_TASKS[@]}"; do
  ...
  OUTPUT_DIR="artifacts/results/gemma-2-9b-it-expert-${MODEL_FNAME}/olmes"
...
MULTI_MODEL="MergeBench/gemma-2-9b-it_multilingual"
MULTI_OUTPUT_DIR="artifacts/results/gemma-2-9b-it-expert-$(basename $MULTI_MODEL)/lm-eval"
