...
MODEL="gemma-2-2b-it"
METHODS=(tsv actmat wudi mean isoc actmat_gd isoc2 isoc3 actmat_5k ace actmat_gd_5k actmat_mons dare_actmat_gd actmat_softmax_bias actmat_softmax_bias_noident actmat_gd_softmax_bias pretrained actmat_isoc actmat_l1)
