...
# (Optional) Must use a an allowed path
# export OPENCLIP_CACHEDIR=$SCRATCH/openclip
# ***** Command *****
# python src/finetune.py --finetuning-mode=standard --model=ViT-B-16 --world-size=1 --openclip-cachedir=$SCRATCH/openclip --data-location=datasets
```
